    ...
    >
      <div className="grid w-full max-w-[50rem] md:max-w-[60rem] lg:max-w-[70rem] xl:max-w-[85rem] gap-10 rounded-2xl border border-white/15 bg-[#0d0d0d]/90 p-6 md:grid-cols-2 md:p-10">
        ...
        <div className="flex flex-col justify-center">
          ...
          <Link
            href={section.href}
            className="btn-animated mt-8 inline-flex w-fit items-center justify-center rounded-full border border-white bg-[#ED1C2475] px-14 py-4 text-white"
          >
      ...
      {businessSections.map((section) => (
        ...
        >
          ...
          <div className="flex flex-col items-center order-2 md:items-start">
            ...
            <Link
              href={section.href}
              className="btn-animated mt-6 inline-flex w-fit items-center justify-center rounded-full border border-white bg-[#ED1C2475] px-10 py-3 text-white md:mt-8 md:px-14 md:py-4"
            >
