...
export default function ContactSection() {
  ...
  return (
    <section className="w-full bg-black py-4 lg:py-20 px-10 sm:px-16 md:px-32 lg:px-24 border-t border-gray-600">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 items-center">
        ...
        <div>
          <Typography
            variant="display-2xl"
            className="text-[#FFFFFF] font-cormorant mb-4 lg:mb-12"
          >
            Send Us A Message
          </Typography>
        ...
        {/* RIGHT SIDE - MAP */}
        <div className="w-full h-[400px] rounded overflow-hidden bg-gray-900">
          <iframe
