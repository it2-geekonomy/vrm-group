  ...
  return (
    <section ref={sectionRef} className="relative w-full h-[50vh] md:h-[80vh] overflow-hidden">
      ...
      <button
        ...
        className="absolute bottom-2 right-2 lg:bottom-6 lg:right-6 z-20 flex items-center lg:font-[0.875rem] gap-2 rounded-full bg-black/50 px-4 py-2 text-white backdrop-blur-sm transition hover:bg-black/70"
      >
        {muted ? (
          <>
